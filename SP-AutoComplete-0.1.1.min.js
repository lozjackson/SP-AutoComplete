...
a?"none":"inline-block";a?d.attr("disabled",!0):d.removeAttr("disabled")}function n(){b.ACFormField.blur(function(a){b.checkField($(a.target).val())});b.ACFormField.keyup(function(a){13==a.keyCode&&$(a.target).blur()})}function p(){var a;b.ACList=[];b.ACFormField=$("input[title='"+b.ACFormField+"']");d=$('input[value="Save"]');a="<ViewFields><FieldRef Name='"+FieldName+"' />";b.AdditionalField&&(a+="<FieldRef Name='"+b.AdditionalField+"' />");a={operation:"GetListItems",webURL:b.WebURL,CAMLViewFields:a+
"</ViewFields>",async:!1,completefunc:function(a,c){$(a.responseXML).SPFilterNode("z:row").each(function(){var a,c=$(this).attr("ows_"+b.FieldName);b.AdditionalField&&(a=$(this).attr("ows_"+b.AdditionalField))&&(c+=" ("+a.slice(a.indexOf("#")+1)+")");"function"===typeof b.ListItemProcess&&(c=b.ListItemProcess(c));b.ACList.push(c)})}};b.ListName&&(a.listName=b.ListName);$().SPServices(a);b.ACFormField.autocomplete({source:b.ACList,minLength:b.MinLength,change:function(){b.AdditionalField&&b.AdditionalFormField&&
b.getAdditionalField($(this))}});k(!0);n()}var b=this,c,d;this.ListName=null;this.FieldName="Name";this.AdditionalField=null;this.MinLength=1;this.ACFormField="Name";this.AdditionalFormField=null;this.HostName=g.location.hostname;this.ListSite=null;this.Http="http";this.WebURL=this.Http+"://"+this.HostName+"/"+this.ListSite;this.ListItemProcess=null;this.DisableSaveButton=!0;this.ACList=[];this.checkField=function(a){e(!1);a&&(h(a),!e()&&0<=a.search(" ")&&(a=a.split(" "),a=a[1]+", "+a[0],h(a)))};
this.getAdditionalField=function(a){if(!a)return!1;var c=a.val().substring(a.val().indexOf("(")+1,a.val().indexOf(")"));b.AdditionalFormField&&$("input[title='"+b.AdditionalFormField+"']").val(c);a.val(a.val().replace(" ("+c+")",""))};if(arguments.length){var l=arguments[0],f;for(f in l)this[f]=l[f]}this.ListName&&this.ACFormField&&p()}})(document,window);